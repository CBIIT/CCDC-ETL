...
loadHelper.getHomePageDocument = () => {
  ...
  contents.push("<p> Resources include repositories, registries, data commons, web sites, and catalogs that either manage or refer to data. Users can browse and filter the list of data resources or enter search terms to identify data of interest. </p>");
  return {
    uid: "home",
